...
//  Shinzo
//
//  Created by Ian White on 25/06/2016.
...
struct GameTitles {
    static let texts = ["Peaceful pond", "Babbling brook", "Surging stream", "Raging river", "Stormy sea"]
    static let colours = [SKColor.init(red: 0, green: 255, blue: 100, alpha: 1),
